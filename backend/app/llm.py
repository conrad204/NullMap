...
def validate_extraction(extraction: Extraction, abstract: str) -> dict:
    ...
    # Half an arm summary cannot be analyzed; keep all of it or none. Means need both
...
coverage: "tests_claim" only if this paper experimentally tested this intervention on this system and measured this outcome; "tests_related" if it tested a neighboring system, analogue, or different outcome; "background_only" if it merely cites or discusses the topic.
        ...
        async with self.semaphore:
            try:
                response = await self.client.responses.parse(
                    ...
                    text_format=schema,
                    # The parse defines the match set and the screen decides which studies
                    # are counted; sampling noise here changed the report between identical runs.
                    temperature=0,
                    store=False,
